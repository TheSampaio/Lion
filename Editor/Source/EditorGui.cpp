...
void LoadIconFont()
{
	...
	static const char8* kUsedIcons =
		...
		ICON_MDI_AXIS_ARROW ICON_MDI_BOOK_OPEN_PAGE_VARIANT ICON_MDI_CHART_BAR ICON_MDI_CLOCK ICON_MDI_CODE_TAGS ICON_MDI_COG
		ICON_MDI_CONSOLE ICON_MDI_CONTENT_COPY ICON_MDI_CONTENT_CUT ICON_MDI_CONTENT_DUPLICATE ICON_MDI_CONTENT_PASTE
		ICON_MDI_CHEVRON_LEFT ICON_MDI_CHEVRON_RIGHT ICON_MDI_CONTENT_SAVE_ALL_OUTLINE ICON_MDI_CONTENT_SAVE_OUTLINE
		ICON_MDI_CUBE_OUTLINE ICON_MDI_CURSOR_DEFAULT
		ICON_MDI_DATABASE_REMOVE_OUTLINE ICON_MDI_DELETE_OUTLINE ICON_MDI_EXIT_TO_APP ICON_MDI_EYE ICON_MDI_EYE_OFF
		ICON_MDI_FILE_DOCUMENT_OUTLINE ICON_MDI_FILE_EYE_OUTLINE ICON_MDI_FILE_MUSIC ICON_MDI_FILE_PLUS_OUTLINE ICON_MDI_FILE_TREE ICON_MDI_FOLDER
		ICON_MDI_FOLDER_MULTIPLE ICON_MDI_FOLDER_OPEN ICON_MDI_FOLDER_OPEN_OUTLINE ICON_MDI_FOLDER_PLUS ICON_MDI_GAMEPAD ICON_MDI_GAMEPAD_VARIANT
		ICON_MDI_GRID ICON_MDI_HAMMER_WRENCH ICON_MDI_HEART ICON_MDI_IMAGE ICON_MDI_IMAGE_OUTLINE ICON_MDI_INFORMATION
		ICON_MDI_INFORMATION_OUTLINE ICON_MDI_KEYBOARD ICON_MDI_LIGHTBULB_ON_OUTLINE ICON_MDI_LIGHTBULB_OUTLINE
		ICON_MDI_LINK_VARIANT_OFF ICON_MDI_LOCK ICON_MDI_LOCK_OPEN_VARIANT ICON_MDI_MAGNIFY
		ICON_MDI_MICROSOFT_WINDOWS ICON_MDI_MONITOR ICON_MDI_MOUSE ICON_MDI_PACKAGE_UP ICON_MDI_PACKAGE_VARIANT_CLOSED
		ICON_MDI_PALETTE ICON_MDI_PAUSE ICON_MDI_PENCIL ICON_MDI_PLAY ICON_MDI_PLUS ICON_MDI_PUZZLE ICON_MDI_REDO
		ICON_MDI_RELOAD ICON_MDI_RESTORE ICON_MDI_ROTATE_RIGHT ICON_MDI_SHAPE ICON_MDI_SHIELD_LOCK
		ICON_MDI_STEP_FORWARD ICON_MDI_STOP ICON_MDI_SWAP_HORIZONTAL ICON_MDI_TUNE ICON_MDI_UNDO ICON_MDI_VECTOR_CIRCLE_VARIANT
		ICON_MDI_VECTOR_SQUARE ICON_MDI_VIDEO ICON_MDI_VIEW_DASHBOARD ICON_MDI_VIEW_DASHBOARD_OUTLINE ICON_MDI_VOLUME_HIGH ICON_MDI_WEIGHT;
