...
namespace Lion
{
	...
	//
	// A shader is created from a single ".lnshader" file that contains both the vertex and the
	...
	public:
		...
		// Creates a shader from a combined ".lnshader" source file for the selected backend.
