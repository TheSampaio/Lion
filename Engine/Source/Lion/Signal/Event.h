...
#define LION_BIND_EVENT(callable) std::bind(&callable, this, std::placeholders::_1)
#define LION_EVENT_TYPE(type) static EventType GetStaticType() { return EventType::type; }\
